...
* */
@Slf4j
@RequestMapping(value="/notice") // -> /notice로 시작하는 url은 무조건 notice컨트롤러에서 처리
...
//        List<NoticeDTO> rList = Optional.ofNullable(
...
//        model.addAttribute("rList", rList);
        ...
        // webapp/WEB-INF/views/notice/noticeList.jsp -> jsp 파일 실행
    ...
    public MsgDTO noticeInsert(HttpServletRequest request, HttpSession session) {
        ...
        try{
            ...
            * */
            ...
            NoticeDTO pDTO = new NoticeDTO(); // 값을 넣어주기 위해 pDTO 생성
            ...
            *
            */
            noticeService.insertNoticeInfo(pDTO); // INoticeService 함수를 호출함
    ...
    * 게시판 글 삭제하기*/
    ...
    public MsgDTO noticeDelete(HttpServletRequest request) {
        ...
        try{
            ...
            //DB에서 게시글 삭제하기
            noticeService.deleteNoticeInfo(pDTO); //전달 받은 값을 DTO에 저장했으니 INoticeService안에 있는 delete함수를 호출해 값을 처리한다.
